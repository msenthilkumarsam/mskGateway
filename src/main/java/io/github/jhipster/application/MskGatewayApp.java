...
@EnableZuulProxy
public class MskGatewayApp {

    private static final Logger log = LoggerFactory.getLogger(MskGatewayApp.class);

    private final Environment env;

    public MskGatewayApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes mskGateway.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(MskGatewayApp.class);
